...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "generated/authenticate/@prisma-client-authenticate",
    "authenticate/@prisma-client-authenticate",
  ]
...
path.join(process.cwd(), "generated/authenticate/@prisma-client-authenticate/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "generated/authenticate/@prisma-client-authenticate/schema.prisma")
